...
public class ApplicationController {
    ...
    public PrecisePage<Application> listApplications(@RequestParam(defaultValue = "0") @PositiveOrZero int offset,
            @RequestParam(defaultValue = "10") @Positive @Max(value = 50) int quantity, @RequestParam String group) throws ApiException {
        try {
            return applicationBusiness.get(offset, quantity, group);
